export const experiences = [
  {
    ...
    details: [
      ...
      "Contributed to algorithmic research on linear-time sorting techniques, later published and presented."
    ]
  },
  {
    ...
    details: [
      ...
      "Achieved RMSE 2.02 (state-of-the-art) and delivered scalable workflows in Python and TensorFlow with deployment via Flask REST API, React.js dashboard, and PostgreSQL for climate data visualization."
    ]
  },
  {
  ...
  },
  {
    ...
    details: [
      ...
      "Developed a full-stack web app (Node.js, React.js, JavaScript) with an AI observability layer that processes thousands of pages of project data into real-time status insights, reducing human review effort by 80%."
    ]
  }
];
